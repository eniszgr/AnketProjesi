...
namespace AnketProjesi.Controllers
{
    public class ChartsController : Controller
    {
        ...
        public ChartsController(anket3DbContext context)
        {
        ...
        public async Task<IActionResult> MesleklerCharts()
        {
            // Mühendislerin verileri
            var anketIDsMuhendis = await _context.Ankets
                .Where(a => a.TurId == 1)
                .Select(a => a.AnketId)
            .ToListAsync();

            var aCountMuhendis = await _context.Cevaplars
                .Where(c => anketIDsMuhendis.Contains((int)c.AnketId) && c.Cevap == "a")
            .CountAsync();

            var bCountMuhendis = await _context.Cevaplars
                .Where(c => anketIDsMuhendis.Contains((int)c.AnketId) && c.Cevap == "b")
            .CountAsync();

            var cCountMuhendis = await _context.Cevaplars
                .Where(c => anketIDsMuhendis.Contains((int)c.AnketId) && c.Cevap == "c")
                .CountAsync();

            var totalMuhendis = aCountMuhendis + bCountMuhendis + cCountMuhendis;
            if (totalMuhendis == 0)
                totalMuhendis = 1;

            var percentAMuhendis = ((double)aCountMuhendis / totalMuhendis) * 100;
            var percentBMuhendis = ((double)bCountMuhendis / totalMuhendis) * 100;
            var percentCMuhendis = ((double)cCountMuhendis / totalMuhendis) * 100;
            ...
            // Doktor verileri
            var anketIDsDoktor = await _context.Ankets
                .Where(a => a.TurId == 2)
                .Select(a => a.AnketId)
            .ToListAsync();
            ...
            // Müdür verileri
            var anketIDsMudur = await _context.Ankets
                .Where(a => a.TurId == 4)
                .Select(a => a.AnketId)
                .ToListAsync();
            ...
            // PartialView'ı döndür
            return PartialView("partial_charts/MesleklerCharts");
        }


        public async Task<IActionResult> SorularCharts()
        { // ilk soru verileri
            ...
            ViewData["percentASoruBir"] = ((double)aCountSoruBir / totalSoruBir) * 100;
            ViewData["percentBSoruBir"] = ((double)bCountSoruBir / totalSoruBir) * 100;
            ViewData["percentCSoruBir"] = ((double)cCountSoruBir / totalSoruBir) * 100;
            ...
            return PartialView("partial_charts/SorularCharts");
        }


        public async Task<IActionResult> GenelTablo()
        {
            //toplam veri
            ...
            return PartialView("partial_charts/GenelTablo");
        }

        public async Task<IActionResult> Filtresiz()
        {
            //toplam veri
            var aCount = await _context.Cevaplars.CountAsync(c => c.Cevap == "a");
            var bCount = await _context.Cevaplars.CountAsync(c => c.Cevap == "b");
            ...
            return PartialView("partial_charts/Filtresiz");
        }
    }
}
